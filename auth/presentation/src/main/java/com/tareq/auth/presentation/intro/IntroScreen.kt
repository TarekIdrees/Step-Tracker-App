package com.tareq.auth.presentation.intro
...
fun IntroScreen(
    ...
    GradientBackground {
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.step_tracker_description),
...
@Composable
private fun StepTrackerLogoVertical(modifier: Modifier = Modifier) {
    Column(
        modifier = modifier,
        ...
        Text(
            text = stringResource(id = R.string.step_tracker),
            fontSize = 24.sp,
