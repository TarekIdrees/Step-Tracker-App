package com.tareq.wear.run.presentation.util
...
fun ExerciseError.toUiText(): UiText? {
    return when(this) {
        ...
        ExerciseError.ONGOING_DIFFERENT_EXERCISE -> {
        ...
        ExerciseError.UNKNOWN -> UiText.StringResource(com.tareq.core.presentation.ui.R.string.error_unknown)
