...
import com.tareq.core.presentation.designsystem.ArrowLeftIcon
...
fun StepTrackerToolbar(
    ...
    var isDropDownMenuOpened by rememberSaveable {
        ...
        actions = {
            if (menuItems.isNotEmpty()) {
                Box {
                    ...
                    IconButton(onClick = { isDropDownMenuOpened = true }) {
                        Icon(
...
@Preview
@Composable
private fun StepTrackerToolbarPreview() {
    StepTrackerTheme {
        StepTrackerToolbar(
            showBackButton = true,
            title = "Step Tracker",
