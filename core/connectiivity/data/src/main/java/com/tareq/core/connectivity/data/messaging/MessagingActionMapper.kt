package com.tareq.core.connectivity.data.messaging
...
fun MessagingAction.toMessagingActionDto(): MessagingActionDto {
    return when (this) {
        ...
        MessagingAction.CancelRunningTracker -> MessagingActionDto.CancelRunningTracker
    }
}
...
fun MessagingActionDto.toMessagingAction(): MessagingAction {
    return when (this) {
        ...
        MessagingActionDto.CancelRunningTracker -> MessagingAction.CancelRunningTracker
    }
}